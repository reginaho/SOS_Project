...
public abstract class SOSGame {
    ...
    protected Cell[][] grid;
//    protected Combination[][] combinations;
...
//            combinations = new Combination[rowNum][columnNum];
...
//    public abstract Boolean makeMove(int row, int column);
    public int findCombination(int row, int column){
        ...
        if(move == Cell.O){
            //check cell
            //have an and to check move on both and then another inner statement
            try {
...
//                    combinations[][]
    ...
    //add to stack?
    //add other info as well such as who did it and turn?
    class Combination{
        //it would be better to transfer the x and y
        int row1;
        int col1;
        int row2;
        int col2;
        ...
        //hmmm both the first and second character are s
